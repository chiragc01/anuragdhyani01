export const projects = [
  {
    title: 'HealthyMe',
    description: "AI based Healthcare system that tracks your diseases and gives you insight reports along with ML model to test disease with symptoms. The App is called HealthyME and it is a simple web app that has machine learning APIs for disease testing too as a feature",
      image: '/images/1.png',
      tags: ['Python','Flask', 'Sk-learn', 'Machine Learning'],
    source: 'https://github.com/Dhyani01/Healthcare',
  ...
  },
  {
    ...
    description:"This project uses Natural Language Processing techniques to predict bias in Indian political news articles. Compared LSTM and SVM for classification of the text",
...
export const TimeLineData = [
  { year: 2017_20, text: 'Started my journey in B.Tech Computer science and learned about DSA then got to know about machine learning and decided to pursue masters', },
